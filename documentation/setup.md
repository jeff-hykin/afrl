...
- (Don't need to git clone)
- Run this: `repo=https://github.com/josiahcoad/AFRL branch=master setup_or_copy=setup eval "$(curl -fsSL git.io/JE2Zm || wget -qO- git.io/JE2Zm)"`
