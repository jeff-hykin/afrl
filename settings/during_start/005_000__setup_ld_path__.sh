...
export LD_LIBRARY_PATH="$("$__FORNIX_NIX_COMMANDS/lib_path_for" libGLU):$LD_LIBRARY_PATH"
export LD_LIBRARY_PATH="$("$__FORNIX_NIX_COMMANDS/lib_path_for" xorg.libX11):$LD_LIBRARY_PATH"
